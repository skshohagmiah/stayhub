...
const Categories = () => {
  ...
  return (
    <section className="categories fixed top-[4.2rem] md:top-[4.9rem] z-30 bg-white shadow-sm flex items-center space-x-12 justify-between max-w-7xl mx-auto p-3 overflow-scroll">
